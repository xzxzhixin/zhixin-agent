 ...
 */
export class RemoveAgentTeamMemberStructuredTool extends BaseAgentTeamStructuredTool<typeof REMOVE_AGENT_TEAM_MEMBER_SCHEMA> {
    /** description: 工具说明。 */
    ...
    protected override executeAgentTeamTool(
        ...
        return executeRemoveAgentTeamMemberInStructuredTool(
            scope,
            arg,
        );
    }
