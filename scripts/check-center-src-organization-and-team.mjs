...
[
  ...
  "command-structured-tool.ts",
  "mcp-tool-executor.ts",
  "mcp-tool-specs.ts",
  "mcp-structured-tool.ts",
  "create-agent-team-tool.ts",
  "disband-agent-team-tool.ts",
  "add-agent-team-member-tool.ts",
  "remove-agent-team-member-tool.ts",
